...
System Agent는 system-layer 최고 의사결정 에이전트다. Event를 해석해 Alert와 Insight를 생성하고, Device Role / Operation Plan / Mission Proposal을 추천하며, 사용자 승인 후 Mission / Step / Task를 배정한다.
...
- Mission Proposal 생성, Approval 기록, Mission / Step / Task 상태 갱신
